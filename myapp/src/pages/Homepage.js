            ...
            <section className='showcase' id='Homepage'>
                <div className="overlay">
                    <article className='text-white ' >
                        {company && <><h1 data-text='All the SpaceX Capsule data in one place' className='heading text-center capitalize'>SpaceX Capsule </h1>
                            <div className="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3 max-w-4xl mx-auto mt-10 lg:gap-20 px-5 ">
                                ...
                                <article>
                                    ...
                                    <ul className='text-sm opacity-75' >
                                        ...
                                        <li className='mb-1'>is valid at {company.valuation.toLocaleString()} B</li>
                                    </ul>
                                </article>
                                <article>
                            ...
                            <h1 className='max-w-3xl mx-auto text-center mt-10'>{company.summary}</h1>
                        </>
                        }
